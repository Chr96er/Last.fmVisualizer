...
function(input, output, session) {
  ...
  output$manual <- renderUI({
    manual(
      "The Last.fmVisualizer application plots a user's top tags, artists, albums, and tracks as sunburst charts, using the last.fm API. For Artist, Artist-Album, and Artist-Track charts a context menu allows access to the selected element's Spotify and Last.fm link. Insert a last.fm user name or select a friend to get started.
